...
export default {
    ...
    features: [
        ...
        {
            tcid: '15',
            name: '@studio-table-copy-code',
            path: '/studio.html',
            browserParams: '#page=content&path=nala&query=',
            data: {
                cardid: '48a759ce-3c9a-4158-9bc3-b21ffa07e8e4',
            },
            tags: '@mas-studio @copy-code',
        },
        {
            tcid: '16',
            name: '@studio-table-copy-code-variant',
            path: '/studio.html',
            browserParams: '#page=content&path=nala&query=',
            data: {
                cardid: '481a2002-9a4e-447b-a990-b3e56fdb2d14',
            ...
            tags: '@mas-studio @copy-code @regional-variations',
        },
        {
            tcid: '17',
            name: '@studio-table-copy-code-denied',
            path: '/studio.html',
            browserParams: '#page=content&path=nala&query=',
            data: {
                cardid: '48a759ce-3c9a-4158-9bc3-b21ffa07e8e4',
