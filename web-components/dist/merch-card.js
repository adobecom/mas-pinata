var nr=Object.defineProperty;var or=a=>{throw TypeError(a)};var $a=(a,t,e)=>t in a?nr(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var Ba=(a,t)=>()=>(a&&(t=a(a=0)),t);var qa=(a,t)=>{for(var e in t)nr(a,e,{get:t[e],enumerable:!0})};var d=(a,t,e)=>$a(a,typeof t!="symbol"?t+"":t,e),zt=(a,t,e)=>t.has(a)||or("Cannot "+e);var s=(a,t,e)=>(zt(a,t,"read from private field"),e?e.call(a):t.get(a)),g=(a,t,e)=>t.has(a)?or("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),m=(a,t,e,r)=>(zt(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),S=(a,t,e)=>(zt(a,t,"access private method"),e);var cr=(a,t,e,r)=>({set _(i){m(a,t,i,e)},get _(){return s(a,t,r)}});var Pt={};qa(Pt,{default:()=>Be});import{LitElement as Ha,html as ot,css as Ua}from"./lit-all.min.js";function ja(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var P,Be,_t=Ba(()=>{P=class P extends Ha{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();P.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}showTooltip(){P.activeTooltip&&P.activeTooltip!==this&&(P.activeTooltip.closeOverlay(),P.activeTooltip.tooltipVisible=!1,P.activeTooltip.requestUpdate()),P.activeTooltip=this,this.tooltipVisible=!0}hideTooltip(){P.activeTooltip===this&&(P.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?ot`<merch-icon
    ...
    `);Be=P;customElements.define("mas-mnemonic",Be)});import{LitElement as Ln}from"./lit-all.min.js";import{css as dr,unsafeCSS as lr}from"./lit-all.min.js";var y="(max-width: 767px)",A="(max-width: 1199px)",w="(min-width: 768px)",u="(min-width: 1200px)",L="(min-width: 1600px)",sr={matchMobile:window.matchMedia(y),matchDesktop:window.matchMedia(`${u} and (not ${L})`),matchDesktopOrUp:window.matchMedia(u),matchLargeDesktop:window.matchMedia(L),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},f=sr;function nt(){return sr.isDesktop}var hr=dr`
    :host {
...
`,pr=()=>[dr`
    ...
    `);customElements.define("merch-addon",ye);import{html as pt,nothing as Ja}from"./lit-all.min.js";var we,Ve=class Ve{constructor(t){d(this,"card");g(this,we);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,we,s(this,we)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,we)}insertVariantStyle(){let t=this.constructor.name;if(!Ve.styleMap[t]){Ve.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t||this.card.heightSync===!1)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(r))||0;i>o&&n.style.setProperty(r,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),pt`
        ...
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return mt(this.card.variant)}};we=new WeakMap,d(Ve,"styleMap",{});var x=Ve;import{html as Nt,css as ei}from"./lit-all.min.js";var Ar=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as We,css as ti}from"./lit-all.min.js";var Lr=`
:root {
...
`;var gt=class extends x{constructor(t){super(t)}getGlobalCSS(){return Pr}renderLayout(){return _r` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":_r`<hr />`} ${this.secureLabelFooter}`}};import{html as X,css as ri,unsafeCSS as Rr}from"./lit-all.min.js";var Mr=`
  :root {
...
`;var ai=32,Nr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},ke=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?X`<slot name="secure-transaction-label">
    ...
    `);import{html as ut,css as ii,unsafeCSS as Dr,nothing as ni}from"./lit-all.min.js";var Or=`
  :root {
...
`;var oi=32,Fr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Se=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>ut` <footer>
    ...
    `);import{html as Ke,css as ci,nothing as ft}from"./lit-all.min.js";var Ir=`
:root {
...
`;var Gr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ce=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return jr}priceOptionsProvider(t,e){t.dataset.template===O&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(e.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Ot` ${this.badge}
    ...
    `);import{html as Dt,css as di}from"./lit-all.min.js";var Vr=`
:root {
...
`;var Yr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Te=class extends x{constructor(t){super(t)}getGlobalCSS(){return Kr}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose()}renderLayout(){return hi`
    ...
    `);import{html as Ft,css as mi}from"./lit-all.min.js";var Qr=`
:root {
...
`;var Xr={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Le=class extends x{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Qr}renderLayout(){return Ft`${this.cardImage}
    ...
    `);import{html as gi,css as ui}from"./lit-all.min.js";var Zr=`
:root {
...
`;var It={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},ze=class extends x{getGlobalCSS(){return Zr}get aemFragmentMapping(){return It}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price");let r=this.card.querySelector('[slot="callout-content"]');r&&this.updateCardElementMinHeight(r,"callout");let i=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');i&&this.updateCardElementMinHeight(i,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(i=>i.onceSettled?.()));let t=this.getContainer();if(!t)return;let e=t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),r=34;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let c=o.textContent.trim().length>r;o.classList.toggle("small-font-size-button",c)})}),f.isDesktopOrUp&&requestAnimationFrame(()=>{e.forEach(i=>i.variantLayout?.syncHeights?.())})}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!nt()&&this.card.setAttribute("data-expanded","true"))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(nt())t.removeAttribute("data-expanded");else{let i=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",i?"true":"false")}};e();let r=window.matchMedia(y);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(y).removeEventListener("change",this.mediaQueryListener)}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||nt())return;let i=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",i)}renderLayout(){return gi`
    ...
    `);import{html as ea,css as fi}from"./lit-all.min.js";var Jr=`
:root {
...
`;var $t={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Pe=class extends x{getGlobalCSS(){return Jr}get aemFragmentMapping(){return $t}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return ea`
    ...
    `);import{html as Bt,css as vi,nothing as xi}from"./lit-all.min.js";var ta=`
...
`;var ra={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},bi=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],_e=class extends x{constructor(t){super(t)}getGlobalCSS(){return ta}renderLayout(){return Bt`
    ...
    `);import{css as yi,html as wi}from"./lit-all.min.js";var aa=`
...
`;var ia={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Me=class extends x{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return aa}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${b}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return wi`
            ${this.badge}
            <div class="body">
    ...
    `);var bt=new Map,na=new WeakMap,oa=new Map,k=(a,t,e=null,r=null,i)=>{bt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};k("catalog",Ee,Tr,Ee.variantStyle);k("image",oe);k("inline-heading",gt);k("mini-compare-chart",ke,Nr,ke.variantStyle);k("mini-compare-chart-mweb",Se,Fr,Se.variantStyle);k("plans",_,vt,_.variantStyle,_.collectionOptions);k("plans-students",_,Br,_.variantStyle,_.collectionOptions);k("plans-education",_,$r,_.variantStyle,_.collectionOptions);k("plans-v2",Z,Ur,Z.variantStyle,Z.collectionOptions);k("product",Ce,Gr,Ce.variantStyle);k("segment",Ae,Wr,Ae.variantStyle);k("media",Te,Yr,Te.variantStyle);k("headless",_e,ra,_e.variantStyle);k("special-offers",Le,Xr,Le.variantStyle);k("simplified-pricing-express",ze,It,ze.variantStyle);k("full-pricing-express",Pe,$t,Pe.variantStyle);k("mini",Me,ia,Me.variantStyle);k("image",oe,zr,oe.variantStyle);var Ei=(a,t,e)=>{try{let r=oa.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),oa.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},qt=a=>{let t=bt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=na.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?Ei(a,r,i):{};return na.set(a,{appliedVariant:a.variant,...n}),new e(a)};function mt(a){return bt.get(a)?.fragmentMapping}function ca(a){return bt.get(a)?.collectionOptions}var sa=document.createElement("style");sa.innerHTML=`
:root {
...
`;document.head.appendChild(sa);function yt(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),c=Ht(r)?r:a;n=o.get(c)}if(i&&n==null){let o=Ht(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Si(Ht(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[a]}var ki=a=>typeof a=="boolean",wt=a=>typeof a=="function";var Ht=a=>typeof a=="string";function la(a,t){if(ki(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Si(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var J=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(st);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var ce={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},da=1e3;function Ci(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ha(a){if(a==null)return;let t=typeof a;if(t==="function")return a.name?`function ${a.name}`:"function";if(t==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:r,originatingRequest:i,status:n}=a;return[r,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!ce.serializableTypes.includes(e))return e}return a}function Ai(a,t){if(!ce.ignoredProperties.includes(a))return ha(t)}var Ut={append(a){if(a.level!=="error")return;let{message:t,params:e}=a,r=[],i=[],n=t;e.forEach(p=>{p!=null&&(Ci(p)?r:i).push(p)}),r.length&&(n+=" "+r.map(ha).join(" "));let{pathname:o,search:c}=window.location,l=`${ce.delimiter}page=${o}${c}`;l.length>da&&(l=`${l.slice(0,da)}<trunc>`),n+=l,i.length&&(n+=`${ce.delimiter}facts=`,n+=JSON.stringify(i,Ai)),window.lana?.log(n,ce)}};function pa(a){Object.assign(ce,Object.fromEntries(Object.entries(a).filter(([t,e])=>t in ce&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ma={LOCAL:"local",PROD:"prod",STAGE:"stage"},jt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Gt=new Set,Vt=new Set,ga=new Map,ua={append({level:a,message:t,params:e,timestamp:r,source:i}){console[a](`${r}ms [${i}] %c${t}`,"font-weight: bold;",...e)}},fa={filter:({level:a})=>a!==jt.DEBUG},Ti={filter:()=>!1};function Li(a,t,e,r,i){return{level:a,message:t,namespace:e,get params(){return r.length===1&&wt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:i,timestamp:performance.now().toFixed(3)}}function zi(a){[...Vt].every(t=>t(a))&&Gt.forEach(t=>t(a))}function va(a){let t=(ga.get(a)??0)+1;ga.set(a,t);let e=`${a} #${t}`,r={id:e,namespace:a,module:i=>va(`${r.namespace}/${i}`),updateConfig:pa};return Object.values(jt).forEach(i=>{r[i]=(n,...o)=>zi(Li(i,n,a,o,e))}),Object.seal(r)}function Et(...a){a.forEach(t=>{let{append:e,filter:r}=t;wt(r)&&Vt.add(r),wt(e)&&Gt.add(e)})}function Pi(a={}){let{name:t}=a,e=la(yt("commerce.debug",{search:!0,storage:!0}),t===ma.LOCAL);return Et(e?ua:fa),t===ma.PROD&&Et(Ut),Ye}function _i(){Gt.clear(),Vt.clear()}var Ye={...va(kr),Level:jt,Plugins:{consoleAppender:ua,debugFilter:fa,quietFilter:Ti,lanaAppender:Ut},init:Pi,reset:_i,use:Et};var Mi="mas-commerce-service",Vs=Ye.module("utilities"),Ri={requestId:st,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var kt=a=>window.setTimeout(a);function Wt(){return document.getElementsByTagName(Mi)?.[0]}function xa(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(Ri)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function ba(a,t={},e=2,r=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,t);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw i}var ya="fragment",wa="author",Ea="preview",ka="loading",Sa="timeout",Kt="aem-fragment",Ca="eager",Aa="cache",Ni=[Ca,Aa],j,se,$,Yt=class{constructor(){g(this,j,new Map);g(this,se,new Map);g(this,$,new Map)}clear(){s(this,j).clear(),s(this,se).clear(),s(this,$).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,j).set(t.id,t),t.fields?.originalId&&s(this,j).set(t.fields.originalId,t),s(this,$).has(t.id)){let[,r]=s(this,$).get(t.id);r()}if(s(this,$).has(t.fields?.originalId)){let[,r]=s(this,$).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:i,value:n}=t.references[r];i==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,j).has(t)}entries(){return s(this,j).entries()}get(t){return s(this,j).get(t)}getAsPromise(t){let[e]=s(this,$).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,$).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,se).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,se).set(t,e)),e}remove(t){s(this,j).delete(t),s(this,se).delete(t),s(this,$).delete(t)}};j=new WeakMap,se=new WeakMap,$=new WeakMap;var ee=new Yt,Re,B,W,D,M,C,Qe,Xe,q,Ze,Je,Ne,H,Ta,La,Qt,za,St=class extends HTMLElement{constructor(){super(...arguments);g(this,H);d(this,"cache",ee);g(this,Re);g(this,B,null);g(this,W,null);g(this,D,null);g(this,M);g(this,C);g(this,Qe,Ca);g(this,Xe,5e3);g(this,q);g(this,Ze,!1);g(this,Je,0);g(this,Ne)}static get observedAttributes(){return[ya,ka,Sa,wa,Ea]}attributeChangedCallback(e,r,i){e===ya&&(m(this,M,i),m(this,C,ee.getFetchInfo(i))),e===ka&&Ni.includes(i)&&m(this,Qe,i),e===Sa&&m(this,Xe,parseInt(i,10)),e===wa&&m(this,Ze,["","true"].includes(i)),e===Ea&&m(this,Ne,i)}connectedCallback(){if(!s(this,q)){if(s(this,D)??m(this,D,ie(this)),m(this,Ne,s(this,D).settings?.preview),s(this,Re)??m(this,Re,s(this,D).log.module(`${Kt}[${s(this,M)}]`)),!s(this,M)||s(this,M)==="#"){s(this,C)??m(this,C,ee.getFetchInfo("missing-fragment-id")),S(this,H,Qt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,C)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,q)&&!await Promise.race([s(this,q),Promise.resolve(!1)]))return;e&&ee.remove(s(this,M)),s(this,Qe)===Aa&&await Promise.race([ee.getAsPromise(s(this,M)),new Promise(c=>setTimeout(c,s(this,Xe)))]);try{m(this,q,S(this,H,za).call(this)),await s(this,q)}catch(c){return S(this,H,Qt).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:n,wcs:o}=s(this,B)||{};return o&&!yt("mas.disableWcsCache")&&s(this,D).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(fe,{detail:{...this.data,references:r,referencesTree:i,placeholders:n,...s(this,C)},bubbles:!0,composed:!0})),s(this,q)}get updateComplete(){return s(this,q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,W)?s(this,W):(s(this,Ze)?this.transformAuthorData():this.transformPublishData(),s(this,W))}get rawData(){return s(this,B)}transformAuthorData(){let{fields:e,id:r,tags:i,variationId:n,settings:o={},priceLiterals:c={},dictionary:l={},placeholders:p={}}=s(this,B);m(this,W,e.reduce((h,{name:v,multiple:T,values:R})=>(h.fields[v]=T?R:R[0],h),{fields:{},id:r,tags:i,settings:o,priceLiterals:c,dictionary:l,placeholders:p,variationId:n}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:l={},variationId:p}=s(this,B);m(this,W,Object.entries(e).reduce((h,[v,T])=>(h.fields[v]=T?.mimeType?T.value:T??"",h),{fields:{},id:r,tags:i,settings:n,priceLiterals:o,dictionary:c,placeholders:l,variationId:p}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${o}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,M),{locale:s(this,D).settings.locale,apiKey:s(this,D).settings.wcsApiKey,fullContext:!0})}};Re=new WeakMap,B=new WeakMap,W=new WeakMap,D=new WeakMap,M=new WeakMap,C=new WeakMap,Qe=new WeakMap,Xe=new WeakMap,q=new WeakMap,Ze=new WeakMap,Je=new WeakMap,Ne=new WeakMap,H=new WeakSet,Ta=async function(e){cr(this,Je)._++;let r=`${Kt}:${s(this,M)}:${s(this,Je)}`,i=`${r}${lt}`,n=`${r}${dt}`;if(s(this,Ne)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new J(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,C).stale=!1,s(this,C).url=e,o=await ba(e,{cache:"default",credentials:"omit"}),S(this,H,La).call(this,o),s(this,C).status=o?.status,s(this,C).measure=xe(performance.measure(n,i)),s(this,C).retryCount=o.retryCount,!o?.ok)throw new J("Unexpected fragment response",{response:o,...s(this,D).duration});return await o.json()}catch(c){if(s(this,C).measure=xe(performance.measure(n,i)),s(this,C).retryCount=c.retryCount,s(this,B))return s(this,C).stale=!0,s(this,Re).error("Serving stale data",s(this,C)),s(this,B);let l=c.message??"unknown";throw new J(`Failed to fetch fragment: ${l}`,{})}},La=function(e){Object.assign(s(this,C),xa(e))},Qt=function(e){m(this,q,null),s(this,C).message=e,this.classList.add("error");let r={...s(this,C),...s(this,D).duration};s(this,Re).error(e,r),this.dispatchEvent(new CustomEvent(ve,{detail:r,bubbles:!0,composed:!0}))},za=async function(){var l;this.classList.remove("error"),m(this,W,null);let e=ee.get(s(this,M));if(e)return m(this,B,e),!0;let{masIOUrl:r,wcsApiKey:i,country:n,locale:o}=s(this,D).settings,c=`${r}/fragment?id=${s(this,M)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await S(this,H,Ta).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,M)),ee.add(e),m(this,B,e),!0},d(St,"cache",ee);customElements.define(Kt,St);import{LitElement as Oi,html as Xt,css as Di,nothing as Fi}from"./lit-all.min.js";import{unsafeHTML as Ii}from"./lit-all.min.js";var $i=a=>a?a.startsWith("sp-icon-")?Xt`${Ii(`<${a} class="badge-icon"></${a}>`)}`:Xt`<img src="${a}" class="badge-icon" />`:Fi,Oe=class extends Oi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Xt`<div class="badge">
    ...
    `),d(et,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",et);import{html as Zt,css as Ui,LitElement as ji,nothing as Pa}from"./lit-all.min.js";var tt=class extends ji{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Zt`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?Zt`<slot name="content"></slot>`:Pa}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Zt`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Pa}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(tt,"styles",Ui`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
