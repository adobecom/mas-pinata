...
`;var Bc={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},$e,Zt=class extends C{constructor(r){super(r);w(this,$e);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Hc}priceOptionsProvider(r,i){r.dataset.template===le&&(i.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(i.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i))}renderLayout(){return f` ${this.badge}
...
`;document.head.appendChild(il);var al="fragment",nl="author",ol="preview",sl="loading",cl="timeout",Fn="aem-fragment",ll="eager",dl="cache",hp=[ll,dl],He,kt,Pe,Un=class{constructor(){w(this,He,new Map);w(this,kt,new Map);w(this,Pe,new Map)}clear(){p(this,He).clear(),p(this,kt).clear(),p(this,Pe).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(p(this,He).set(t.id,t),t.fields?.originalId&&p(this,He).set(t.fields.originalId,t),p(this,Pe).has(t.id)){let[,i]=p(this,Pe).get(t.id);i()}if(p(this,Pe).has(t.fields?.originalId)){let[,i]=p(this,Pe).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return p(this,He).has(t)}entries(){return p(this,He).entries()}get(t){return p(this,He).get(t)}getAsPromise(t){let[r]=p(this,Pe).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),p(this,Pe).set(t,[r,i]),r}getFetchInfo(t){let r=p(this,kt).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},p(this,kt).set(t,r)),r}remove(t){p(this,He).delete(t),p(this,kt).delete(t),p(this,Pe).delete(t)}};He=new WeakMap,kt=new WeakMap,Pe=new WeakMap;var rt=new Un,sr,Le,Ye,be,ve,J,ei,ti,Re,ri,ii,cr,Me,hl,pl,Gn,ml,ea=class extends HTMLElement{constructor(){super(...arguments);w(this,Me);u(this,"cache",rt);w(this,sr);w(this,Le,null);w(this,Ye,null);w(this,be,null);w(this,ve);w(this,J);w(this,ei,ll);w(this,ti,5e3);w(this,Re);w(this,ri,!1);w(this,ii,0);w(this,cr)}static get observedAttributes(){return[al,sl,cl,nl,ol]}attributeChangedCallback(r,i,a){r===al&&(b(this,ve,a),b(this,J,rt.getFetchInfo(a))),r===sl&&hp.includes(a)&&b(this,ei,a),r===cl&&b(this,ti,parseInt(a,10)),r===nl&&b(this,ri,["","true"].includes(a)),r===ol&&b(this,cr,a)}connectedCallback(){if(!p(this,Re)){if(p(this,be)??b(this,be,xt(this)),b(this,cr,p(this,be).settings?.preview),p(this,sr)??b(this,sr,p(this,be).log.module(`${Fn}[${p(this,ve)}]`)),!p(this,ve)||p(this,ve)==="#"){p(this,J)??b(this,J,rt.getFetchInfo("missing-fragment-id")),Z(this,Me,Gn).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(p(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(p(this,Re)&&!await Promise.race([p(this,Re),Promise.resolve(!1)]))return;r&&rt.remove(p(this,ve)),p(this,ei)===dl&&await Promise.race([rt.getAsPromise(p(this,ve)),new Promise(s=>setTimeout(s,p(this,ti)))]);try{b(this,Re,Z(this,Me,ml).call(this)),await p(this,Re)}catch(s){return Z(this,Me,Gn).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=p(this,Le)||{};return o&&!B("mas.disableWcsCache")&&p(this,be).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(lt,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...p(this,J)},bubbles:!0,composed:!0})),p(this,Re)}get updateComplete(){return p(this,Re)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return p(this,Ye)?p(this,Ye):(p(this,ri)?this.transformAuthorData():this.transformPublishData(),p(this,Ye))}get rawData(){return p(this,Le)}transformAuthorData(){let{fields:r,id:i,tags:a,variationId:n,settings:o={},priceLiterals:s={},dictionary:c={},placeholders:l={}}=p(this,Le);b(this,Ye,r.reduce((d,{name:h,multiple:m,values:g})=>(d.fields[h]=m?g:g[0],d),{fields:{},id:i,tags:a,settings:o,priceLiterals:s,dictionary:c,placeholders:l,variationId:n}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={},variationId:l}=p(this,Le);b(this,Ye,Object.entries(r).reduce((d,[h,m])=>(d.fields[h]=m?.mimeType?m.value:m??"",d),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c,variationId:l}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r),a={locale:p(this,be).settings.locale,apiKey:p(this,be).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??p(this,be).settings.instant;return n&&(a.instant=n),await i(p(this,ve),a)}};sr=new WeakMap,Le=new WeakMap,Ye=new WeakMap,be=new WeakMap,ve=new WeakMap,J=new WeakMap,ei=new WeakMap,ti=new WeakMap,Re=new WeakMap,ri=new WeakMap,ii=new WeakMap,cr=new WeakMap,Me=new WeakSet,hl=async function(r){no(this,ii)._++;let i=`${Fn}:${p(this,ve)}:${p(this,ii)}`,a=`${i}${pt}`,n=`${i}${mt}`;if(p(this,cr)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new Ne(`Failed to generate preview: ${s.message}`,{})}performance.mark(a);let o;try{if(p(this,J).stale=!1,p(this,J).url=r,o=await Hi(r,{cache:"default",credentials:"omit"}),Z(this,Me,pl).call(this,o),p(this,J).status=o?.status,p(this,J).measure=ze(performance.measure(n,a)),p(this,J).retryCount=o.retryCount,!o?.ok)throw new Ne("Unexpected fragment response",{response:o,...p(this,be).duration});return await o.json()}catch(s){if(p(this,J).measure=ze(performance.measure(n,a)),p(this,J).retryCount=s.retryCount,p(this,Le))return p(this,J).stale=!0,p(this,sr).error("Serving stale data",p(this,J)),p(this,Le);let c=s.message??"unknown";throw new Ne(`Failed to fetch fragment: ${c}`,{})}},pl=function(r){Object.assign(p(this,J),Ai(r))},Gn=function(r){b(this,Re,null),p(this,J).message=r,this.classList.add("error");let i={...p(this,J),...p(this,be).duration};p(this,sr).error(r,i),this.dispatchEvent(new CustomEvent(dt,{detail:i,bubbles:!0,composed:!0}))},ml=async function(){var c;this.classList.remove("error"),b(this,Ye,null);let r=rt.get(p(this,ve));if(r)return b(this,Le,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=p(this,be).settings,s=`${i}/fragment?id=${p(this,ve)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Me,hl).call(this,s),(c=r.fields).originalId??(c.originalId=p(this,ve)),rt.add(r),b(this,Le,r),!0},u(ea,"cache",rt);customElements.define(Fn,ea);M();zn();var pp=e=>e?e.startsWith("sp-icon-")?f`${Yr(`<${e} class="badge-icon"></${e}>`)}`:f`<img src="${e}" class="badge-icon" />`:E,lr=class extends G{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return f`<div class="badge">
    ...
    `),u(ai,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ai);M();var ni=class extends G{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return f`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?f`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:E}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};u(ni,"styles",y`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
...
`;var[ry,iy,Wn,Yn,Cl,Tl]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Xn=class extends G{static get properties(){return{closed:{type:Boolean,reflect:!0},selected:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},maxInput:{type:Number,attribute:"max-input"},options:{type:Array},highlightedIndex:{type:Number},defaultValue:{type:Number,attribute:"default-value",reflect:!0},title:{type:String}}}static get styles(){return Sl}constructor(){super(),this.options=[],this.title="",this.closed=!0,this.min=0,this.max=0,this.step=0,this.maxInput=void 0,this.defaultValue=void 0,this.selectedValue=0,this.highlightedIndex=0,this.toggleMenu=this.toggleMenu.bind(this),this.closeMenu=this.closeMenu.bind(this),this.openMenu=this.openMenu.bind(this),this.handleClickOutside=this.handleClickOutside.bind(this),this.boundKeydownListener=this.handleKeydown.bind(this),this.handleKeyupDebounced=Dr(this.handleKeyup.bind(this),500),this.debouncedQuantityUpdate=Dr(this.handleQuantityUpdate.bind(this),500)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.boundKeydownListener),window.addEventListener("mousedown",this.handleClickOutside),this.addEventListener(Nt,this.debouncedQuantityUpdate)}handleKeyup(t){t.key===Yn||t.key===Wn||(this.handleInput(),this.sendEvent())}selectValue(){if(!this.closed){let t=this.options[this.highlightedIndex];if(!t){this.closed=!0;return}this.selectedValue=t,this.handleMenuOption(this.selectedValue),this.closed=!0}}handleKeydown(t){switch(t.key){case" ":this.selectValue();break;case"Escape":this.closed=!0;break;case Tl:this.selectValue();break;case Yn:this.closed?this.openMenu():this.highlightedIndex=(this.highlightedIndex+1)%this.options.length,t.preventDefault();break;case Wn:this.closed||(this.highlightedIndex=(this.highlightedIndex-1+this.options.length)%this.options.length),t.preventDefault();break;case Cl:this.selectValue(),t.preventDefault();break}t.composedPath().includes(this)&&t.stopPropagation()}adjustInput(t,r){this.selectedValue=r,t.value=r,this.highlightedIndex=this.options.indexOf(r)}handleInput(){let t=this.shadowRoot.querySelector(".text-field-input"),r=t.value.replace(/\D/g,"");t.value=r;let i=parseInt(r);if(!isNaN(i))if(i>0&&i!==this.selectedValue){let a=i;this.maxInput&&i>this.maxInput&&(a=this.maxInput),this.min&&a<this.min&&(a=this.min),this.adjustInput(t,a)}else this.adjustInput(t,this.selectedValue||this.min||1)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside),this.removeEventListener("keydown",this.boundKeydownListener),this.removeEventListener(Nt,this.debouncedQuantityUpdate)}generateOptionsArray(){let t=[];if(this.step>0)for(let r=this.min;r<=this.max;r+=this.step)t.push(r);return t}update(t){if(t.has("min")||t.has("max")||t.has("step")||t.has("defaultValue")){this.options=this.generateOptionsArray();let r=this.options[0],i=this.defaultValue!=null&&this.options.includes(this.defaultValue)?this.defaultValue:r;this.highlightedIndex=this.options.indexOf(i),this.handleMenuOption(i)}super.update(t)}handleClickOutside(t){t.composedPath().includes(this)||this.closeMenu()}toggleMenu(){this.closed=!this.closed,this.adjustPopoverPlacement(),this.closed&&(this.highlightedIndex=this.options.indexOf(this.selectedValue))}closeMenu(){this.closed=!0,this.highlightedIndex=this.options.indexOf(this.selectedValue)}openMenu(){this.closed=!1,this.adjustPopoverPlacement()}adjustPopoverPlacement(){let t=this.shadowRoot.querySelector(".popover");this.closed||t.getBoundingClientRect().bottom<=window.innerHeight?t.setAttribute("placement","bottom"):t.setAttribute("placement","top")}handleMouseEnter(t){this.highlightedIndex=t}handleMenuOption(t,r){t===this.max&&this.shadowRoot.querySelector(".text-field-input")?.focus(),this.selectedValue=t,this.sendEvent(),r&&this.closeMenu()}sendEvent(){let t=new CustomEvent(te,{detail:{option:this.selectedValue},bubbles:!0});this.dispatchEvent(t)}get configured(){return this.title||this.min||this.step}get offerSelect(){return this.querySelector("merch-offer-select")}get popover(){return f` <div
        ...
        >
            ${this.options.map((t,r)=>f`
                ...
                `)}
        </div>`}handleQuantityUpdate({detail:{quantity:t}}){if(t&&t!==this.selectedValue){this.selectedValue=t;let r=this.shadowRoot.querySelector(".text-field-input");r&&(r.value=t),this.sendEvent()}}render(){return this.configured?f`
            ...
            <div class="text-field">
                ...
                <button
                    ...
                    aria-hidden="true"
                    tabindex="-1"
                    @mousedown="${t=>{t.preventDefault(),this.toggleMenu()}}"
                >
                    <div
        ...
        `:E}};customElements.define("merch-quantity-select",Xn);Yi();M();var kl=`
