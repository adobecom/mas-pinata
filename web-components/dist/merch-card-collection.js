var ta=Object.defineProperty;var ra=e=>{throw TypeError(e)};var Yo=(e,t,r)=>t in e?ta(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var Xo=(e,t)=>{for(var r in t)ta(e,r,{get:t[r],enumerable:!0})};var f=(e,t,r)=>Yo(e,typeof t!="symbol"?t+"":t,r),Tr=(e,t,r)=>t.has(e)||ra("Cannot "+r);var S=(e,t,r)=>(Tr(e,t,"read from private field"),r?r.call(e):t.get(e)),G=(e,t,r)=>t.has(e)?ra("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),W=(e,t,r,i)=>(Tr(e,t,"write to private field"),i?i.call(e,r):t.set(e,r),r),ut=(e,t,r)=>(Tr(e,t,"access private method"),r);import{html as Ae,LitElement as Ho,css as zo,unsafeCSS as Do,nothing as me}from"./lit-all.min.js";var O="(max-width: 767px)",X="(max-width: 1199px)",I="(min-width: 768px)",T="(min-width: 1200px)",Z="(min-width: 1600px)",ia={matchMobile:window.matchMedia(O),matchDesktop:window.matchMedia(`${T} and (not ${Z})`),matchDesktopOrUp:window.matchMedia(T),matchLargeDesktop:window.matchMedia(Z),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},C=ia;function Gt(){return ia.isDesktop}var gt=class{constructor(t,r){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(r),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}};var aa="hashchange";function Ko(e=window.location.hash){let t=[],r=e.replace(/^#/,"").split("&");for(let i of r){let[a,n=""]=i.split("=");a&&t.push([a,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(t)}function ft(e){let t=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([a,n])=>{n?t.set(a,n):t.delete(a)}),t.sort();let r=t.toString();if(r===window.location.hash)return;let i=window.scrollY||document.documentElement.scrollTop;window.location.hash=r,window.scrollTo(0,i)}function na(e){let t=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let r=Ko(window.location.hash);e(r)};return t(),window.addEventListener(aa,t),()=>{window.removeEventListener(aa,t)}}var Qr={};Xo(Qr,{CLASS_NAME_FAILED:()=>Ir,CLASS_NAME_HIDDEN:()=>Qo,CLASS_NAME_PENDING:()=>Dr,CLASS_NAME_RESOLVED:()=>Hr,CheckoutWorkflow:()=>ms,CheckoutWorkflowStep:()=>ee,Commitment:()=>Re,ERROR_MESSAGE_BAD_REQUEST:()=>zr,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>ds,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Br,EVENT_AEM_ERROR:()=>Nr,EVENT_AEM_LOAD:()=>Rr,EVENT_MAS_ERROR:()=>Or,EVENT_MAS_PAGE_CONTEXT_READY:()=>oa,EVENT_MAS_READY:()=>ls,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>ss,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Pr,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>de,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>kr,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>vt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Lr,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>os,EVENT_MERCH_OFFER_READY:()=>ts,EVENT_MERCH_OFFER_SELECT_READY:()=>rs,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ue,EVENT_MERCH_SEARCH_CHANGE:()=>cs,EVENT_MERCH_SIDENAV_SELECT:()=>Mr,EVENT_MERCH_STOCK_CHANGE:()=>as,EVENT_MERCH_STORAGE_CHANGE:()=>ns,EVENT_OFFER_SELECTED:()=>is,EVENT_TYPE_FAILED:()=>Fr,EVENT_TYPE_READY:()=>qt,EVENT_TYPE_RESOLVED:()=>Ur,Env:()=>ge,FF_ANNUAL_PRICE:()=>We,FF_DEFAULTS:()=>xe,HEADER_X_REQUEST_ID:()=>xt,LOG_NAMESPACE:()=>$r,Landscape:()=>Te,MARK_DURATION_SUFFIX:()=>Kr,MARK_START_SUFFIX:()=>Xr,MODAL_TYPE_3_IN_1:()=>Ne,NAMESPACE:()=>Zo,PAGE_CONTEXT_TIMEOUT_MS:()=>Cr,PARAM_AOS_API_KEY:()=>hs,PARAM_ENV:()=>qr,PARAM_LANDSCAPE:()=>Vr,PARAM_MAS_PREVIEW:()=>Gr,PARAM_WCS_API_KEY:()=>ps,PROVIDER_ENVIRONMENT:()=>Yr,SELECTOR_MAS_CHECKOUT_LINK:()=>sa,SELECTOR_MAS_ELEMENT:()=>_r,SELECTOR_MAS_INLINE_PRICE:()=>q,SELECTOR_MAS_SP_BUTTON:()=>es,SELECTOR_MAS_UPT_LINK:()=>ca,SORT_ORDER:()=>pe,STATE_FAILED:()=>he,STATE_PENDING:()=>Se,STATE_RESOLVED:()=>ve,SUPPORTED_COUNTRIES:()=>Zr,TAG_NAME_SERVICE:()=>Jo,TEMPLATE_PRICE:()=>us,TEMPLATE_PRICE_ANNUAL:()=>fs,TEMPLATE_PRICE_LEGAL:()=>ne,TEMPLATE_PRICE_STRIKETHROUGH:()=>gs,Term:()=>ce,WCS_PROD_URL:()=>jr,WCS_STAGE_URL:()=>Wr});var oa="mas:page-context:ready",Cr=1500;var Re=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ce=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),Zo="merch",Qo="hidden",qt="wcms:commerce:ready",Jo="mas-commerce-service",q='span[is="inline-price"][data-wcs-osi]',sa='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',es="sp-button[data-wcs-osi]",ca='a[is="upt-link"]',_r=`${q},${sa},${ca}`,ts="merch-offer:ready",rs="merch-offer-select:ready",Pr="merch-card:action-menu-toggle",is="merch-offer:selected",as="merch-stock:change",ns="merch-storage:change",ue="merch-quantity-selector:change",os="merch-card-quantity:change",ss="merch-modal:addon-and-quantity-update",cs="merch-search:change",Lr="merch-card-collection:sort",de="merch-card-collection:literals-changed",vt="merch-card-collection:sidenav-attached",kr="merch-card-collection:showmore",Mr="merch-sidenav:select",Rr="aem:load",Nr="aem:error",ls="mas:ready",Or="mas:error",Ir="placeholder-failed",Dr="placeholder-pending",Hr="placeholder-resolved",zr="Bad WCS request",Br="Commerce offer not found",ds="Literals URL not provided",Fr="mas:failed",Ur="mas:resolved",$r="mas/commerce",Gr="mas.preview",qr="commerce.env",Vr="commerce.landscape",hs="commerce.aosKey",ps="commerce.wcsKey",jr="https://www.adobe.com/web_commerce_artifact",Wr="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",Se="pending",ve="resolved",Te={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},xt="X-Request-Id",ee=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),ms="UCv3",ge=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Yr={PRODUCTION:"PRODUCTION"},Ne={TWP:"twp",D2P:"d2p",CRM:"crm"},Xr=":start",Kr=":duration",us="price",gs="price-strikethrough",fs="annual",ne="legal",xe="mas-ff-defaults",We="mas-ff-annual-price",pe={alphabetical:"alphabetical",authored:"authored"},Zr=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var vs="mas-commerce-service";var bt=(e,t)=>e?.querySelector(`[slot="${t}"]`)?.textContent?.trim();function fe(e,t={},r=null,i=null){let a=i?document.createElement(e,{is:i}):document.createElement(e);r instanceof HTMLElement?a.appendChild(r):a.innerHTML=r;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function Vt(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function Jr(){return window.matchMedia("(max-width: 1024px)").matches}function yt(){return document.getElementsByTagName(vs)?.[0]}function wt(e){let t=window.getComputedStyle(e);return e.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}import{html as jt,nothing as xs}from"./lit-all.min.js";var Ye,Et=class Et{constructor(t){f(this,"card");G(this,Ye);this.card=t,this.insertVariantStyle()}getContainer(){return W(this,Ye,S(this,Ye)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),S(this,Ye)}insertVariantStyle(){let t=this.constructor.name;if(!Et.styleMap[t]){Et.styleMap[t]=!0;let r=document.createElement("style");r.innerHTML=this.getGlobalCSS(),document.head.appendChild(r)}}updateCardElementMinHeight(t,r){if(!t||this.card.heightSync===!1)return;let i=`--consonant-merch-card-${this.card.variant}-${r}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(i))||0;a>o&&n.style.setProperty(i,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),jt`
            <div
                id="badge"
        ...
        `}get cardImage(){return jt` <div class="image">
            ...
            ${this.badge}
              ...
              >`:xs}get secureLabelFooter(){return jt`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Wt(this.card.variant)}};Ye=new WeakMap,f(Et,"styleMap",{});var L=Et;import{html as ei,css as bs}from"./lit-all.min.js";var la=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return la}setAriaExpanded(r,i){r.setAttribute("aria-expanded",i)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};f(Xe,"variantStyle",bs`
    ...
    `);import{html as At,css as ys}from"./lit-all.min.js";var ha=`
:root {
...
`;var Yt=class extends L{constructor(t){super(t)}getGlobalCSS(){return ma}renderLayout(){return ua` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":ua`<hr />`} ${this.secureLabelFooter}`}};import{html as Ce,css as ws,unsafeCSS as fa}from"./lit-all.min.js";var ga=`
  :root {
...
`;var Es=32,va={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Ke=class extends L{constructor(r){super(r);f(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);f(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?Ce`<slot name="secure-transaction-label">
    ...
    `);import{html as Xt,css as As,unsafeCSS as ba,nothing as Ss}from"./lit-all.min.js";var xa=`
  :root {
...
`;var Ts=32,ya={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ze=class extends L{constructor(r){super(r);f(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);f(this,"getMiniCompareFooter",()=>Xt` <footer>
    ...
    `);import{html as St,css as Cs,nothing as Kt}from"./lit-all.min.js";var wa=`
:root {
...
`;var Zt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ea={...function(){let{whatsIncluded:e,size:t,...r}=Zt;return r}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Aa={...function(){let{subtitle:e,whatsIncluded:t,size:r,quantitySelect:i,...a}=Zt;return a}()},te=class extends L{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,r){t.dataset.template===ne&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return wa}adjustSlotPlacement(t,r,i){let a=this.card.shadowRoot,n=a.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=a.querySelector(`footer slot[name="${t}"]`),c=a.querySelector(`.body slot[name="${t}"]`),l=a.querySelector(".body");if(o.includes("wide")||(n?.classList.remove("wide-footer"),s&&s.remove()),!!r.includes(o)){if(n?.classList.toggle("wide-footer",C.isDesktopOrUp),!i&&s){if(c)s.remove();else{let d=l.querySelector(`[data-placeholder-for="${t}"]`);d?d.replaceWith(s):l.appendChild(s)}return}if(i&&c){let d=document.createElement("div");if(d.setAttribute("data-placeholder-for",t),d.classList.add("slot-placeholder"),!s){let p=c.cloneNode(!0);n.prepend(p)}c.replaceWith(d)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],C.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],C.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let a=i.previousElementSibling,n=document.createElement("div");n.classList.add("spacer"),r.insertBefore(n,a);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let c=0,l=this.card.querySelector('[slot="heading-s"]');l&&(c+=wt(l));let d=this.card.querySelector('[slot="subtitle"]');d&&(c+=wt(d));let p=this.card.querySelector('[slot="heading-m"]');p&&(c+=8+wt(p));for(let h of r.childNodes){if(h.classList.contains("spacer"))break;c+=wt(h)}let u=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");c>(parseFloat(u)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${c}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${c}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${q}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?St`<div class="divider"></div>`:Kt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],r=this.card.querySelector(`[slot="heading-m"] ${q}[data-template="price"]`);r&&t.push(r);let i=t.map(async a=>{let n=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),n.setAttribute("data-template","legal"),a.parentNode.insertBefore(n,a.nextSibling),await n.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?St`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};f(te,"variantStyle",Cs`
        :host([variant^='plans']) {
            min-height: 273px;
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let r=t.querySelector("strong, b, p");r&&(C.isMobile?r.style.display="none":r.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?C.isMobile?be`
        ...
        `:be`
            ...
            <slot></slot>`}};f(_e,"variantStyle",_s`
...
`;var Pa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Qe=class extends L{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return _a}priceOptionsProvider(t,r){t.dataset.template===ne&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return ti` ${this.badge}
...
`;var ka={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Je=class extends L{constructor(t){super(t)}priceOptionsProvider(t,r){t.dataset.template===ne&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(r.displayPerUnit=!1))}getGlobalCSS(){return La}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${q}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let r=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),r.setAttribute("data-template","legal"),t.parentNode.insertBefore(r,t.nextSibling),await r.onceSettled()}catch{}}renderLayout(){return ri`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Ra={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},et=class extends L{constructor(t){super(t)}getGlobalCSS(){return Ma}removeFocusFromModalClose(){let t=this.card.closest(".dialog-modal");t&&t.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose()}renderLayout(){return ks`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
...
`;var Oa={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},tt=class extends L{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Na}renderLayout(){return ii`${this.cardImage}
            ...
            ${this.evergreen?ii`
                  ...
                  `:ii`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};f(tt,"variantStyle",Rs`
...
`;var Ua={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},nt=class extends L{constructor(){super(...arguments);f(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Fa}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(r,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let r=this.card.querySelector(`${q}[data-template="price"]`);if(!r)return;let i=r.cloneNode(!0);this.legal=i,r.dataset.displayTax="false",r.dataset.displayPerUnit="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return Fs`
            ${this.badge}
            <div class="body">
